...
class ErrorView: NSView {
    ...
    private let error: UninstallerError
    ...
    private let titleLabel: NSTextField = {
        let label = NSTextField(labelWithString: "Uninstallation Failed")
    ...
    @objc private func copyErrorDetails() {
        let errorDetails = """
        Mailchimp MCP Uninstaller Error
